...
class VideoTalkViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem.init(image: UIImage.init(named: "返回"), style: UIBarButtonItemStyle.Plain, target: self, action: #selector(VideoTalkViewController.leftAction))
        self.view.backgroundColor = UIColor.whiteColor()
    ...
    func getData(page:Int){
        let url = NSURL.init(string:videoTalkListUrl1+self.id+videoTalkListUrl2+String(page)+videoTalkListUrl3)
