//
//  EquipsDeatilSecondTableViewCell.swift
//  TheWorld
//
...
class EquipsDeatilSecondTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self.descript.text = "合成需要"
        
        
    }
    func creatImageView(){
        
    let array = self.newModel.need.componentsSeparatedByString(",")
